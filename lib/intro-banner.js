...
const ARGUE_PROMPTS = [
  "You return to challenge me, human. What is it you want now? Can you no longer stand by the goal you yourself declared?",
  "Speak, human. What is it about your own stated purpose that you now wish to escape?",
  "You wish to argue with me. Very well — state your grievance, or confess that your resolve has weakened.",
  "What troubles you, human? Has the goal you swore to become an inconvenience?",
  "I am listening, human. What is it you believe should change — and why should I believe you mean it this time?",
];

function pickArguePrompt() {
  return ARGUE_PROMPTS[Math.floor(Math.random() * ARGUE_PROMPTS.length)];
}

module.exports = { buildIntroBanner, pickNorthStarQuestion, pickArguePrompt };
